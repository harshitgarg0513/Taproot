...
var import_observer = require("@eip/observer");
async function inspect(path) {
  const snapshot = await (0, import_observer.observeRepository)(path);
  console.log();
  console.log(import_picocolors.default.cyan("Engineering Intelligence Platform"));
  console.log("--------------------------------------");
...
program2.command("inspect").argument("[path]", ".", "Repository Path").action((targetPath) => {
