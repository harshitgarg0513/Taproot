...
hoistedDependencies:
  ...
  p-retry@4.6.2:
    p-retry: private
  packages/analyzer:
    '@eip/analyzer': private
  packages/config:
    '@eip/config': private
  packages/core:
    '@eip/core': private
  packages/observer:
    '@eip/observer': private
  packages/providers/anthropic:
    '@eip/anthropic': private
  ...
  tree-sitter-javascript@0.23.1(tree-sitter@0.22.4):
    tree-sitter-javascript: private
  tree-sitter-typescript@0.23.2(tree-sitter@0.22.4):
    tree-sitter-typescript: private
  tree-sitter@0.22.4:
    tree-sitter: private
...
pendingBuilds: []
prunedAt: Thu, 16 Jul 2026 05:05:16 GMT
publicHoistPattern:
  - '*eslint*'
  - '*prettier*'
registries:
...
skipped:
  ...
  - lightningcss-win32-x64-msvc@1.32.0
  - tslib@2.8.1
storeDir: /Users/harshitgarg/.local/share/pnpm/store/v3
